...
<div class="row m-0 justify-content-center px-md-5 px-5 my-5">
    <div class="col-md-4 col-6 text-start bg-orange text-light ps-md-5 pt-2">
        <p class="h4 text">Pindah Program Studi</p>
    </div>
...
<div class="row m-0 px-5">
    <div class="col-7">
      <label for="instansi" class="form-label">Program studi tujuan</label>
...
<p class="text-start mx-md-5 mx-3 my-3">Proses verifikasi pindah program studi</p>
