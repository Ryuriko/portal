...
<div class="row m-0 px-5">
    ...
    <div class="col-7 mt-2">
      ...
      <input type="text" class="form-control bg-silver" id="ditujukan" name="ditujukan">
    </div>
    <div class="col-7 mt-2">
      <label for="kode" class="form-label">Kode perusahaan</label>
      <input type="text" class="form-control bg-silver" id="kode" name="kode">
    </div>
    <div class="col-12 mt-2">
        <label for="JudulSkripsi" class="form-label">Topik praktek kerja/magang</label>
...
<p class="text-start mx-md-5 mx-3 my-3">Proses verifikasi magang</p>
